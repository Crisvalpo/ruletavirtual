...
export default function ScreenLayout({
    ...
    return (
        <>
            {children}
            <div className="orientation-lock-overlay fixed inset-0 z-[99999] bg-[#050505]/95 backdrop-blur-xl flex-col items-center justify-center p-6 text-center select-none font-sans">
                <style>{`
                ...
                <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10 max-w-sm w-full shadow-2xl flex flex-col items-center gap-8 relative overflow-hidden">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-gray-400 text-sm font-medium leading-relaxed">
                            Este juego requiere modo horizontal (Landscape) para funcionar correctamente.
                        </p>
                    </div>
